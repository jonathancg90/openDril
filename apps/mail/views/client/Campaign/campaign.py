...
class CampaignListView(LoginRequiredMixin, ListView):
    ...
    template_name = 'client/campaign/list.html'
...
class CampaignCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'client/campaign/create.html'
...
class CampaignUpdateView(LoginRequiredMixin, UpdateView):
    ...
    success_url = reverse_lazy('campaign_list_view')
    form_class = CampaignCreateForm
    template_name = 'client/campaign/edit.html'
...
class CampaignDetailListView(LoginRequiredMixin, TemplateView):
    ...
    template_name = 'client/campaign/detail.html'
